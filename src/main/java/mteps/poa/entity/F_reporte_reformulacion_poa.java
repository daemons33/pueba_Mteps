...
@NamedStoredProcedureQuery(name = "mteps_plan.f_reporte_reformulacion_poa", procedureName = "mteps_plan.f_reporte_reformulacion_poa", resultClasses = {
		F_reporte_reformulacion_poa.class }, parameters = {
...
@Entity
public class F_reporte_reformulacion_poa {
	@Id	
	...
	public String estado_reformulacion;
	public Integer id_tipo_reformulacion;
	public String codigo_reformulacion;
	@Type(type = "jsonb")
	@Column(columnDefinition = "jsonb")
