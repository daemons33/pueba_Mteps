...
@NamedStoredProcedureQuery(name = "mteps_plan.f_reporte_reform_presupuesto_gasto", procedureName = "mteps_plan.f_reporte_reform_presupuesto_gasto", resultClasses = {
		F_reporte_reform_presupuesto_gasto.class }, parameters = {
...
@Entity
public class F_reporte_reform_presupuesto_gasto {
	@Id	
