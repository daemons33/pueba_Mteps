...
@NamedStoredProcedureQuery(name = "mteps_plan.f_reporte_te_seguimiento", procedureName = "mteps_plan.f_reporte_te_seguimiento", resultClasses = {
		F_reporte_te_seguimiento.class }, parameters = {
...
@Entity
public class F_reporte_te_seguimiento {
	@Id
