...
@NamedStoredProcedureQuery(name="mteps_tramites.f_obtener_tramite_codigo_manual",
procedureName = "mteps_tramites.f_obtener_tramite_codigo_manual",
resultClasses = {FobtenerTramiteCodigoManual.class},
parameters = {
		@StoredProcedureParameter(name = "id", type = String.class, mode = ParameterMode.IN)
})

@Entity
public class FobtenerTramiteCodigoManual {
	@Id
