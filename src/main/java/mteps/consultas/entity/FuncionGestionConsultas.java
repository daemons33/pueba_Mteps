...
@NamedStoredProcedureQuery(name="mteps_denuncias.p_gestion_consulta",
procedureName = "mteps_denuncias.p_gestion_consulta",
resultClasses = {FuncionGestionConsultas.class},
parameters = {
...
@Entity
public class FuncionGestionConsultas {
	@Id
