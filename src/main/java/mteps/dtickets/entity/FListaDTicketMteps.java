...
@NamedStoredProcedureQuery(name="mteps_d_tickets.f_lista_d_tickets_mteps",
procedureName = "mteps_d_tickets.f_lista_d_tickets_mteps",
resultClasses = {FListaDTicketMteps.class},
parameters = {
...
@Entity
public class FListaDTicketMteps {
