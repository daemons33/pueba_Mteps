 ...
 *         &lt;element name="pNumeroUnicoDocumento" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "", propOrder = {
    ...
    "pNumeroUnicoDocumento"
})
@XmlRootElement(name = "ObtenerDocumentoPorCodigoUnico")
public class ObtenerDocumentoPorCodigoUnico {
    ...
    @XmlElementRef(name = "pNumeroUnicoDocumento", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pNumeroUnicoDocumento;
    ...
    /**
     * Obtiene el valor de la propiedad pNumeroUnicoDocumento.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getPNumeroUnicoDocumento() {
        return pNumeroUnicoDocumento;
    }

    /**
     * Define el valor de la propiedad pNumeroUnicoDocumento.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setPNumeroUnicoDocumento(JAXBElement<String> value) {
        this.pNumeroUnicoDocumento = value;
    }
