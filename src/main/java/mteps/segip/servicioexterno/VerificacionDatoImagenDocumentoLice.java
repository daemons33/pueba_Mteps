 ...
 *         &lt;element name="pCategoriaLicencia" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlRootElement(name = "VerificacionDatoImagenDocumentoLice")
public class VerificacionDatoImagenDocumentoLice {
    ...
    @XmlElementRef(name = "pCategoriaLicencia", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pCategoriaLicencia;
    ...
    /**
     * Obtiene el valor de la propiedad pCategoriaLicencia.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getPCategoriaLicencia() {
        return pCategoriaLicencia;
    }

    /**
     * Define el valor de la propiedad pCategoriaLicencia.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setPCategoriaLicencia(JAXBElement<String> value) {
        this.pCategoriaLicencia = value;
    }
