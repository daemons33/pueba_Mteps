...
@NamedStoredProcedureQuery(name = "mteps_inspecciones.f_obtener_inspeccion_id1", procedureName = "mteps_inspecciones.f_obtener_inspeccion_id1", resultClasses = {
		FObtenerInspeccionId1.class }, parameters = {
				@StoredProcedureParameter(name = "v_id", type = Integer.class, mode = ParameterMode.IN)})
@Entity
public class FObtenerInspeccionId1 {
	@Id
