...
@NamedStoredProcedureQuery(name = "mteps_inspecciones.f_obtener_inspecciones", procedureName = "mteps_inspecciones.f_obtener_inspecciones", resultClasses = {
		FObtenerInspecciones.class }, parameters = {
				@StoredProcedureParameter(name = "p_json_pp", type = String.class, mode = ParameterMode.IN)})
@Entity
public class FObtenerInspecciones {
	@Id
